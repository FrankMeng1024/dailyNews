...
class UserSettings(Base):
    ...
    importance_threshold = Column(DECIMAL(3, 2), default=0.50, comment="Min importance score (0.00-1.00) - DEPRECATED")
    quality_level = Column(String(20), default="standard", comment="Quality filter: premium/standard/all")
